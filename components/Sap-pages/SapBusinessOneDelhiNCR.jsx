...
import { sapBusinessOneDelhiNCR } from "../../data/sap/sapBusinessOneDelhiNCR";
import styles from "./SapBusinessOneDelhiNCR.module.css";

export default function SapBusinessOneDelhiNCR() {
  const {
    hero,
    intro,
    whyChooseSap,
  ...
  return (
    <div className={styles.scope}>
      ...
      <CenteredSection
        title={whyDelhiNcr.title}
        description={whyDelhiNcr.description}
        buttons={whyDelhiNcr.buttons}
        background={whyDelhiNcr.background}
        theme="light"
      />
