...
import { sapBusinessOneGurgaon } from "../../data/sap/sapBusinessOneGurgaon";
import styles from "./SapBusinessOneGurgaon.module.css";

export default function SapBusinessOneGurgaon() {
  const {
    hero,
    intro,
    cityBusiness,
    ...
    <div className={styles.scope}>
      ...
      <div className={styles.tintWhite}>
        <CenteredSection
          ...
          subtitle={localBenefits.subtitle}
      ...
      >
        <div className={styles.centeredCopy}>
          <RichContent description={whySapStandsOut.description} theme="light" />
        </div>
